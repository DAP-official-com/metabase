...
export const DataPermissionsHelp = () => (
  <DataPermissionsHelpRoot>
    <DataPermissionsHelpContent>
      ...
      <p>{t`Users can be members of multiple groups, and are given the most permissive level of access for a database or table across all the groups they’re a member of.`}</p>
    ...
    <DataPermissionsHelpFooter>
      <Button icon="reference">{t`Learn more about permissions`}</Button>
    </DataPermissionsHelpFooter>
  </DataPermissionsHelpRoot>
);
